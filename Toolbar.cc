...
Toolbar::Toolbar(PoReader *po_reader) {
	...
	*/
	...
	first_tb->signal_clicked().connect(sigc::mem_fun(this, &Toolbar::onJumpPreviousClicked));
	...
	last_tb->signal_clicked().connect(sigc::mem_fun(this, &Toolbar::onJumpNextClicked));
	this->append(*last_tb);
...
void Toolbar::onJumpPreviousClicked() {
	do {
...
void Toolbar::onJumpNextClicked() {
	do {
